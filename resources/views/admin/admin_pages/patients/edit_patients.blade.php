              ...
              <div class="card-body">
                ...
                <div class="tab-content px-1 pt-1">
                  <div role="tabpanel" class="tab-pane active" id="active" aria-labelledby="Product-info" aria-expanded="true">
                    <form class="form form-horizontal form-bordered" method="POST" action="{{ route('patients.update',$attributes->patient_id) }}"
                      id="MainForm">
                      {{csrf_field()}}
                      <div class="form-body">
                        ...
                        <h4 class="form-section"><i class="la la-eye"></i> Add Patients</h4>
                        {{-- Row 1 --}}
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row">
                              <label class="col-md-3 label-control" for="PatientName">Patient Name</label>
                              <div class="col-md-9">
                                <input type="text" id="PatientName" class="form-control border-primary" placeholder="Patient Name"
                                  name="PatientName" required value="{{$attributes->patient_name}}">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group row last">
                              <label class="col-md-3 label-control" for="ProductStatus">Patient Age</label>
                              <div class="col-md-9">
                                <input type="text" id="PatientAge" class="form-control border-primary" placeholder="Patient Age"
                                  name="PatientAge" required value="{{$attributes->patient_age}}">
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row">
                              <label class="col-md-3 label-control" for="ProductCode">Patient City</label>
                              <div class="col-md-9">
                                <input type="text" id="PatientCity" class="form-control border-primary" placeholder="Patient City"
                                  name="PatientCity" required value="{{$attributes->patient_city}}">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group row last">
                              <label class="col-md-3 label-control" for="PatientContactNumber">Patient Contact Number</label>
                              <div class="col-md-9">
                                <input type="text" id="PatientContactNumber" class="form-control border-primary" placeholder="Patient Contact Number"
                                  name="PatientContactNumber" required value="{{$attributes->patient_contactnumber}}">
                              </div>
                            </div>
                          </div>
                        </div>
  ...
  <footer class="footer footer-static footer-light navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block">Copyright &copy; 2018 <a class="text-bold-800 grey darken-2"
          href="https://themeforest.net/user/pixinvent/portfolio?ref=pixinvent" target="_blank"> </a>, All
