                ...
                <section id="basic">
                    ...
                    <div class="card" style="">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal form-bordered" method="POST" action="{{ route('diease.update',$attributes->diease_id) }}" id="MainForm">
                                    {{csrf_field()}}
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="DieaseName">Diease
                                                        Name</label>
                                                    <div class="col-md-9">
                                                        <input type="text" id="DieaseName" class="form-control border-primary"
                                                            placeholder="Diease Name" name="DieaseName" required value="{{$attributes->diease_name}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
