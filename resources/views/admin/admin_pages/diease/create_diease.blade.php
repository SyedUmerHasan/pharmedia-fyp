                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="{{route('diease.create')}}">Add
                                        diease</a>
                                </li>
                            </ol>
                        </div>
                ...
                <section id="basic">
                    ...
                    <div class="card" style="">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal form-bordered" method="POST" action="{{ route('diease.save') }}"
                                    id="MainForm">
                                    {{csrf_field()}}
                                    <div class="form-body">
                                        @if ($errors->any())
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="DieaseName" class="form-control border-primary"
                                                            placeholder="Diease Name" name="DieaseName" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
