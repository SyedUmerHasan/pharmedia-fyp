                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="{{route('symptom.create')}}">Add
                                        Symtoms</a>
                                </li>
                            </ol>
                        </div>
                ...
                <section id="basic">
                    ...
                    <div class="card" style="">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal form-bordered" method="POST" action="{{ route('symptom.save') }}"
                                    id="MainForm">
                                    {{csrf_field()}}
                                    <div class="form-body">
                                        @if ($errors->any())
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="SymptomsName">Symptoms
                                                        Name</label>
                                                    <div class="col-md-9">
                                                        <input type="text" id="SymptomsName" class="form-control border-primary"
                                                            placeholder="Symptoms Name" name="SymptomsName" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
