                ...
                <section id="basic">
                    ...
                    <div class="card" style="">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal form-bordered" method="POST" action="{{ route('symptom.update',$attributes->symptom_id) }}" id="MainForm">
                                    {{csrf_field()}}
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="SymptomName">Symptom Name</label>
                                                    <div class="col-md-9">
                                                        <input type="text" id="SymptomName" class="form-control border-primary"
                                                            placeholder="Symptom Name" name="SymptomName" required value="{{$attributes->symptom_name}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
