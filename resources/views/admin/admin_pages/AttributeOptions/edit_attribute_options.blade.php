                    ...
                    <div class="card" style="">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form class="form form-horizontal form-bordered" method="POST" action="{{ route('options.update',$attributeOptions->option_id) }}"
                                    id="MainForm">
                                    {{csrf_field()}}
                                    <div class="form-body">
                                                ...
                                                <div class="form-group row last">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="OptionName" class="form-control border-primary"
                                                            placeholder="Option Name" name="OptionName" required value="{{$attributeOptions->option_name}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="col-md-9">
                                                        <select name="AttributeOptions" id="AttributeOptions" class="form-control border-primary">
                                                            ...
                                                            @foreach ($attributes as $attribute)
                                                             @if ($attributeOptions->AttributeDetails->attributes_name == $attribute->attributes_name)
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                ...
                                                @foreach ($attributeOptions->OptionDetails as $item)
                                                <div class="row">
                                                    <div class="col-md-10 col-sm-12">
                                                        <div class="form-group row">
                                                            <div class="col-md-6">
                                                                <input type="text" id="Text" class="form-control border-primary"
                                                                    placeholder="Option Text" name="Text" required
                                                                    value="{{$item->option_details}}">
                                                            </div>
                                                            <div class="col-md-6">
                                                                <input type="text" id="Price" class="form-control border-primary"
                                                                    placeholder="Option Price" name="Price" required
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-10 col-sm-12">
                                                                    <div class="form-group row">
                                                                        <div class="col-md-6">
                                                                            <input type="text" id="Text" class="form-control border-primary"
                                                                                placeholder="Option Text" name="Text"
                                                                                required value="">
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <input type="text" id="Price" class="form-control border-primary"
                                                                                placeholder="Option Price" name="Price"
                                                                                required value="">
                                                                        </div>
                                                                    </div>
                                                                </div>
