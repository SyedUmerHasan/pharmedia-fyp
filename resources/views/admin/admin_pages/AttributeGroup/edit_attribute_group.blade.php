                    ...
                    <div class="card" style="">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <form class="form form-horizontal form-bordered" method="POST" action="{{ route('attributegroup.update',$attributeGroup->attribute_group_id) }}"
                                    id="MainForm">
                                    {{csrf_field()}}
                                    <div class="form-body">
                                        <div class="row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="AttributeName" class="form-control border-primary"
                                                            ...
                                                            value="{{$attributeGroup->attribute_group_name}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" id="AttributeGroupID" class="form-control border-primary"
                                                        ...
                                                        required value="{{$attributeGroup->attribute_group_id}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
