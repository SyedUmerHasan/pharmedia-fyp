                ...
                <section id="basic">
                    ...
                    <div class="card" style="">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal form-bordered" method="POST" action="{{ route('attributegroup.save') }}" id="MainForm">
                                    {{csrf_field()}}
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="AttributeGroupName">Attribute Group
                                                        Name</label>
                                                    <div class="col-md-9">
                                                        <input type="text" id="AttributeGroupName" class="form-control border-primary"
                                                            placeholder="Attribute Group Name" name="AttributeGroupName" required>
                                                    </div>
                                                </div>
                                            </div>
                                            {{-- <div class="col-md-6">
