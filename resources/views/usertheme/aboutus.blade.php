  ...
  <div class="content fix-nav-space"> 
    ...
    <div class="about-us"> 
      ...
      <div class="time-line-sec time-line-2">
        <div class="container">
          <h2 class="text-center">Hi, we are <span>Medikal</span> We care about
            your heath!</h2>
          <div class="row"> 
      ...
      <div class="doctor-list">
        <div class="container"> 
          ...
          <div class="doct-list-style">
            <div class="item"> <a href="#pop-open" class="link popup-vedio video-btn"><img class="img-responsive" src="{{asset("themeassets/images/doc-img-1.jpg")}}" alt="" ></a> </div>
            <div class="item"><a href="#pop-open-1" class="link popup-vedio video-btn"> <img class="img-responsive" src="{{asset("themeassets/images/doc-img-2.jpg")}}" alt="" ></a> </div>
            <div class="item"> <a href="#pop-open" class="link popup-vedio video-btn"><img class="img-responsive" src="{{asset("themeassets/images/doc-img-3.jpg")}}" alt="" ></a> </div>
            <div class="item"> <a href="#pop-open-1" class="link popup-vedio video-btn"><img class="img-responsive" src="{{asset("themeassets/images/doc-img-4.jpg")}}" alt="" ></a> </div>
            <div class="item"> <a href="#pop-open" class="link popup-vedio video-btn"><img class="img-responsive" src="{{asset("themeassets/images/doc-img-5.jpg")}}" alt="" ></a> </div>
            <div class="item"> <a href="#pop-open-1" class="link popup-vedio video-btn"><img class="img-responsive" src="{{asset("themeassets/images/doc-img-6.jpg")}}" alt="" ></a> </div>
            <div class="item"> <a href="#pop-open" class="link popup-vedio video-btn"><img class="img-responsive" src="{{asset("themeassets/images/doc-img-2.jpg")}}" alt="" ></a> </div>
            <div class="item"> <a href="#pop-open-1" class="link popup-vedio video-btn"><img class="img-responsive" src="{{asset("themeassets/images/doc-img-3.jpg")}}" alt="" ></a> </div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="pop-open" class="zoom-anim-dialog mfp-hide pop-open-style">
      <div class="pop_up"> 
        <!-- Doctor Image -->
        <div class="col-sm-6 no-padding"> <img class="img-responsive" src="{{asset("themeassets/images/doctor-1-1.jpg")}}" alt="" > </div>
    ...
    <div id="pop-open-1" class="zoom-anim-dialog mfp-hide pop-open-style">
      <div class="pop_up"> 
        <!-- Doctor Image -->
        <div class="col-sm-6 no-padding"> <img class="img-responsive" src="{{asset("themeassets/images/doctor-2-2.jpg")}}" alt="" > </div>
        <div class="col-md-6 no-padding">
          <div class="doctor-in">
            <h4>Lynn Lambert</h4>
